...
(1, 1, 'jl', '$2y$10$spReWL7w86QumY5yPMVz7OCkobpQC6G0XulBA.TLMpZKnyB4CYiMS'),
(2, 2, 'ir', '$2y$10$Xig/4cJk0lQo03qnXGbuQOjG0H54Wyvs65ocZ/9zYH12UCHIWSHC2'),
(3, 3, 'jh', '$2y$10$LvSbPm.9cBmG.M/d4CM7/O6X5GyhRiA9mnOiLkBAbgAc6YYqBWjGW'),
(4, 4, 'le', '$2y$10$vAn6Lfaj.WK6pyEM5w.HCe9Tk7.FyAteMgGvj0hxhy5kEZc.Jsdaq'),
(5, 5, 'mf', '$2y$10$xRf/wyJM1dCNjXDH0NeiE.nwcWF5dw5a7l0/bbrbbK9Caw8XbtIYu'),
(6, 6, 'sl', '$2y$10$4dN8WgmdFmZAV.isnUu1c.mFXmH5TNjDa8oWBAkLYq5FjK1BKlxJa'),
(7, 7, 'ty', '$2y$10$D3hYy/JCNrGc1iVSucEw7.7U8RDWTNRnP5mjzmd9PEa/1r0BCTkZ2'),
(8, 8, 'mary', '$2y$10$u1ZADm0YTRyviZQNWRG6i.eVjwAEOA6GAEeAGkw23na9Kg.ZFbCfS');
...
(31, 1, '2018-12-04 03:42:27', 'Finally, I am getting closer!'),
(32, 1, '2018-12-04 03:42:44', 'Be patient and all will be fine.'),
(33, 8, '2018-12-04 04:12:06', 'Hello chatter. It is winter!');
...
(1, 'Jiali Jin', 'I am Jiali Jin. I am new to Chatter!'),
...
--
ALTER TABLE `following`
  MODIFY `FollowingID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
--
-- AUTO_INCREMENT for table `login`
--
ALTER TABLE `login`
  MODIFY `loginID` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
